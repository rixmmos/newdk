...
#
# Usage:
#   bash /mnt/c/newdk/start_servers.sh          # launches all three in background
#   bash /mnt/c/newdk/start_servers.sh stop     # stops them
#   bash /mnt/c/newdk/start_servers.sh status   # shows running PIDs + listening ports
#
# Logs: /mnt/c/newdk/dkrixserver/{shared,login,game}server.log
#
# Assumes:
...
SERVER_DIR="/mnt/c/newdk/dkrixserver"
