...
file /mnt/c/dev/newdk/dkrix/build/bin/DarkEden
...
```bash
mkdir -p "/mnt/c/dev/newdk/Darkeden data/Data/Font"
ln -sf /usr/share/fonts/opentype/noto/NotoSansCJK-Regular.ttc \
       "/mnt/c/dev/newdk/Darkeden data/Data/Font/NotoSansCJK-Regular.ttc"
```
...
```bash
ldd /mnt/c/dev/newdk/dkrix/build/bin/DarkEden | grep 'not found'
...
already on disk at `/mnt/c/dev/newdk/Darkeden data/` — that's what we
...
```bash
ls "/mnt/c/dev/newdk/Darkeden data/Data/Info/FileDef.inf"
...
`/mnt/c/dev/newdk/Darkeden data/` and not `~/Darkeden data/`.
...
```bash
ls "/mnt/c/dev/newdk/Darkeden data/Data/Info/infodata/"
...
```bash
cd "/mnt/c/dev/newdk/Darkeden data"

/mnt/c/dev/newdk/dkrix/build/bin/DarkEden "Futec(127.0.0.1:9999)" \
...
```bash
# default: /mnt/c/dev/newdk/... and 127.0.0.1:9999
./client_smoke.sh
...
1. `ldd /mnt/c/dev/newdk/dkrix/build/bin/DarkEden | grep 'not found'`
   (expect empty).
