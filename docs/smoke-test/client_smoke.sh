...
#                        (default $REPO_ROOT/dkrix/build/bin/DarkEden)
#   DKRIX_DATA_DIR     — directory containing Data/
#                        (default $REPO_ROOT/Darkeden data)
...
DKRIX_BIN="${DKRIX_BIN:-$REPO_ROOT/dkrix/build/bin/DarkEden}"
DKRIX_DATA_DIR="${DKRIX_DATA_DIR:-$REPO_ROOT/Darkeden data}"
