...
protected:
	...
	C_SPRITE_PACK *			m_p_etc_image_spk;

	ButtonGroup *				m_pC_button_group;

	SKILLDOMAIN					m_skill_domain;

	int							m_extra_offset_x, m_extra_offset_y;
