...
// SaveToFile / LoadFromFile (folded from CSprite565 in Phase 4A)
// File format is 5:6:5; SDL backend is always 5:6:5 in memory too.
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
bool	
CSprite::SaveToFile(ofstream& file)
{
	// width와 height를 저장한다.
...
//----------------------------------------------------------------------
bool	
CSprite::LoadFromFile(ifstream& file)
{
	// 이거를 하나로 묶어야 하는데..
	if (m_bLoading) 
	{	
...
/*
bool	
CSprite::LoadFromFileToBuffer(ifstream& file)
{
	// width와 height를 Load한다.
