...
public :
	...
	// get packet id
	PacketID_t getPacketID() const throw() { return PACKET_GC_SKILL_TO_TILE_OK_5; }
	...
	// get packet's name
	std::string getPacketName() const throw() { return "GCSkillToTileOK5"; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const throw() { return Packet::PACKET_GC_SKILL_TO_TILE_OK_5; }
...
public :
	...
	// execute packet's handler
	static void execute(GCSkillToTileOK5* pGCSkillToTileOK5, Player* pPlayer) throw ( ProtocolException , Error );
