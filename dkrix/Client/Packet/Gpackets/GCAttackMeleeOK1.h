...
public :
	...
	PacketSize_t getPacketSize () const throw () { return szObjectID + ModifyInfo::getPacketSize(); }
		...
		// get packet's name
		std::string getPacketName () const throw () { return "GCAttackMeleeOK1"; }
...
public :
	...
	// execute packet's handler
	static void execute ( GCAttackMeleeOK1 * pGCAttackMeleeOK1 , Player * pPlayer ) throw ( ProtocolException , Error );
