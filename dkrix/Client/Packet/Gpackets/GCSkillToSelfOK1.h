...
public :
	...
	// get packet's name
	std::string getPacketName() const throw() { return "GCSkillToSelfOK1"; }
...
public :
	...
	// execute packet's handler
	static void execute(GCSkillToSelfOK1* pGCSkillToSelfOK1, Player* pPlayer) throw ( ProtocolException , Error );
