...
//	_MinTrace( szBuffer );
	...
	case NOTICE_EVENT_PREMIUM_HALF_START:			
	...
	case NOTICE_EVENT_PREMIUM_HALF_END:				
...
//		UI_CloseBloodBibleStatus();
	...
	case NOTICE_EVENT_MEET_GRANDMA :					
		break;

	case NOTICE_EVENT_MEET_FISHSHOP_MASTER :			
		break;			

	case NOTICE_EVENT_START_QUEST_ENDING :			
		{
	...
	case NOTICE_EVENT_CONTRACT_GNOMES_HORN :          
		UI_PopupMessage( STRING_MESSAGE_CONTRACT_GNOMES_HORN );
		break;
    
	case NOTICE_EVENT_NOT_ENOUGH_MONEY :              
	...
	case NOTICE_EVENT_GET_RIFINIUM :					
		UI_PopupMessage(STRING_MESSAGE_GET_RIFINIUM);
		break;
	
	case NOTICE_EVENT_INVENTORY_FULL :				
...
//		UI_RunLevelWarStarted( pPacket->getParameter() );
	...
	case  NOTICE_EVENT_SEND_SMS:
		UI_RunNotice(8, 0);
		break;
	case NOTICE_EVENT_GDR_LAIR_ENDING_1: 
	...
	case NOTICE_EVENT_CROWN_PRICE:
		...
		break;
	case NOTICE_EVENT_GIVE_PRESENT_1:                
		...
		break;
    case NOTICE_EVENT_GIVE_PRESENT_2:                
		{
			char szBuf[1024];
		...
		break;
    case NOTICE_EVENT_GIVE_PRESENT_3:                
		{
			char szBuf[1024];
		...
		break;
    case NOTICE_EVENT_GIVE_PRESENT_4:                
		{
			char szBuf[1024];
		...
		break;
    case NOTICE_EVENT_GIVE_PRESENT_5:                
		{
			char szBuf[1024];
		...
		break;
    case NOTICE_EVENT_GIVE_PRESENT_6:                
		{
			char szBuf[1024];
		...
		break;
    case NOTICE_EVENT_GIVE_PRESENT_7:                
		{
			char szBuf[1024];
		...
		break;
    case NOTICE_EVENT_GIVE_PRESENT_8:                
		{
			char szBuf[1024];
		...
		break;
    case NOTICE_EVENT_CAN_OPEN_PRESENT_8:            
		{
			char szBuf[1024];
