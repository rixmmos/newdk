...
public :
	...
	enum
	{
			...
			PACKET_CG_EXCHANGE_LIST,		//   484
			PACKET_CG_EXCHANGE_CREATE_LISTING,	//   485
			PACKET_CG_EXCHANGE_CANCEL_LISTING,	//   486
			PACKET_CG_EXCHANGE_BUY,			//   487
			PACKET_CG_EXCHANGE_CLAIM,		//   488
			PACKET_CG_EXCHANGE_MY_LISTINGS,	//   489
			PACKET_CG_EXCHANGE_ORDERS,		//   490
			PACKET_CG_EXCHANGE_BALANCE,		//   491
			PACKET_GC_EXCHANGE_LIST,		//   492
			PACKET_GC_EXCHANGE_CREATE_LISTING,	//   493
			PACKET_GC_EXCHANGE_CANCEL_LISTING,	//   494
			PACKET_GC_EXCHANGE_BUY,		//   495
			PACKET_GC_EXCHANGE_CLAIM_LIST,		//   496
			PACKET_GC_EXCHANGE_CLAIM_RESULT,	//   497
			PACKET_GC_EXCHANGE_MY_LISTINGS,	//   498
			PACKET_GC_EXCHANGE_ORDERS,		//   499
			PACKET_GC_EXCHANGE_BALANCE,		//   500
