...
CGAbsorbSoul::CGAbsorbSoul() throw() {
    __BEGIN_TRY
    __END_CATCH
}
...
void CGAbsorbSoul::read(SocketInputStream& iStream) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGAbsorbSoul::write(SocketOutputStream& oStream) const throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGAbsorbSoul::execute(Player* pPlayer) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
string CGAbsorbSoul::toString() const throw() {
    __BEGIN_TRY
    StringStream msg;
    msg << "CGAbsorbSoul("
