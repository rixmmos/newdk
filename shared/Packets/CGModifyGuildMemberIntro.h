...
public:
    CGModifyGuildMemberIntro() throw() {}
    ~CGModifyGuildMemberIntro() throw() {}
    ...
    // get/set intro
    const string& getGuildMemberIntro() const throw() {
        return m_GuildMemberIntro;
    }
    void setGuildMemberIntro(const string& intro) throw() {
...
public:
    // execute packet's handler
    static void execute(CGModifyGuildMemberIntro* pCGModifyGuildMemberIntro, Player* pPlayer) throw(ProtocolException, Error);
};
