...
void CLSelectPC::read(SocketInputStream& iStream) throw(ProtocolException, Error)
...
void CLSelectPC::write(SocketOutputStream& oStream) const throw(ProtocolException, Error)
...
void CLSelectPC::execute(Player* pPlayer) throw(ProtocolException, Error)
...
string CLSelectPC::toString() const throw()
