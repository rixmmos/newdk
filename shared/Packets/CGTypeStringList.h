...
public:
    ...
    PacketID_t getPacketID() const throw() {
        return PACKET_CG_TYPE_STRING_LIST;
    }
    ...
    std::string popString() {
        std::string ret = m_StringList.front();
...
private:
    ...
    static void executeApartForce(CGTypeStringList* pPacket, Player* player) throw(ProtocolException, Error);
};
#endif
