...
void CLLogin::read(SocketInputStream& iStream) throw(ProtocolException, Error)
...
void CLLogin::write(SocketOutputStream& oStream) const throw(ProtocolException, Error)
...
void CLLogin::execute(Player* pPlayer) throw(ProtocolException, Error)
...
string CLLogin::toString() const throw()
