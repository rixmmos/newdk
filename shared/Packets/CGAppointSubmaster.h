...
public:
    ...
    PacketID_t getPacketID() const {
        return PACKET_CG_APPOINT_SUBMASTER;
    }
...
public:
    ...
    PacketID_t getPacketID() const throw() {
        return Packet::PACKET_CG_APPOINT_SUBMASTER;
    }
...
// Server-only: CGAppointSubmasterHandler::execute has no client-side
