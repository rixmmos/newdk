...
void CLRegisterPlayer::read(SocketInputStream& iStream) throw(ProtocolException, Error)
...
void CLRegisterPlayer::write(SocketOutputStream& oStream) const throw(ProtocolException, Error)
...
void CLRegisterPlayer::execute(Player* pPlayer) throw(ProtocolException, Error)
...
string CLRegisterPlayer::toString() const throw()
