...
void CGUsePotionFromInventory::read(SocketInputStream& iStream) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGUsePotionFromInventory::write(SocketOutputStream& oStream) const throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGUsePotionFromInventory::execute(Player* pPlayer) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
string CGUsePotionFromInventory::toString() const throw() {
    __BEGIN_TRY
