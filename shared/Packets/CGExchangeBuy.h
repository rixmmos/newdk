...
public:
    ...
    PacketSize_t getPacketSize() const { return sizeof(int64_t) + szBYTE + m_IdempotencyKey.size(); }
...
public:
    ...
    PacketSize_t getPacketMaxSize() const throw() { return sizeof(int64_t) + szBYTE + 64; }
};
