...
public:
    enum { LOGIN_MODE_NORMAL_VALUE = 0, LOGIN_MODE_WEBLOGIN_VALUE = 1 };

    CLLogin() : m_LoginMode(LOGIN_MODE_NORMAL_VALUE) {
        m_strMacAddress = "";
    }
    virtual ~CLLogin() {};
...
public:
    ...
    void setMacAddress(const BYTE* macAddress) {
        memcpy(m_cMacAddress, macAddress, 6 * sizeof(BYTE));
        char tmpStr[13];
    ...
    const BYTE* getRareMacAddress() const throw() {
    ...
    void SetLoginMode(bool webLogin) {
        m_LoginMode = webLogin ? LOGIN_MODE_WEBLOGIN_VALUE : LOGIN_MODE_NORMAL_VALUE;
    }
    void setWebLogin() {
        m_LoginMode = LOGIN_MODE_WEBLOGIN_VALUE;
    }
    bool isWebLogin() const throw() {
        return m_LoginMode == LOGIN_MODE_WEBLOGIN_VALUE;
    }
