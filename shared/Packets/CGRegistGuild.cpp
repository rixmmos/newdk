...
void CGRegistGuild::read(SocketInputStream& iStream) throw(ProtocolException, Error)
...
void CGRegistGuild::write(SocketOutputStream& oStream) const throw(ProtocolException, Error)
...
void CGRegistGuild::execute(Player* pPlayer) throw(ProtocolException, Error)
...
string CGRegistGuild::toString() const throw()
