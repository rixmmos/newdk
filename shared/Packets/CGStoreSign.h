...
public:
    // create packet
    // Client-side PacketFactory still declares these overrides with
    // throw() specs, so the shared definition must keep them to stay
    // compatible with both trees during Phase 12 migration.
