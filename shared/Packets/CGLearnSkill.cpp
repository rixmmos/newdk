...
void CGLearnSkill::read(SocketInputStream& iStream) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGLearnSkill::write(SocketOutputStream& oStream) const throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGLearnSkill::execute(Player* pPlayer) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
string CGLearnSkill::toString() const throw() {
    __BEGIN_TRY
    StringStream msg;
    string domain;
