...
CGUseItemFromInventory::CGUseItemFromInventory() throw() {
    __BEGIN_TRY
...
void CGUseItemFromInventory::read(SocketInputStream& iStream) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGUseItemFromInventory::write(SocketOutputStream& oStream) const throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGUseItemFromInventory::execute(Player* pPlayer) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
string CGUseItemFromInventory::toString() const throw() {
    __BEGIN_TRY
