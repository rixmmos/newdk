...
void CGThrowBomb::read(SocketInputStream& iStream) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGThrowBomb::write(SocketOutputStream& oStream) const throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGThrowBomb::execute(Player* pPlayer) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
string CGThrowBomb::toString() const throw() {
    __BEGIN_TRY
    StringStream msg;
    msg << "CGThrowBomb("
