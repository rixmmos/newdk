...
CGSkillToInventory::CGSkillToInventory() throw() {
    __BEGIN_TRY
...
void CGSkillToInventory::read(SocketInputStream& iStream) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGSkillToInventory::write(SocketOutputStream& oStream) const throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGSkillToInventory::execute(Player* pPlayer) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
string CGSkillToInventory::toString() const throw() {
    __BEGIN_TRY

    StringStream msg;
    msg << "CGSkillToInventory(" << "SkillType:" << (int)m_SkillType << ",ObjectID:" << (int)m_ObjectID
        << ",X:" << (int)m_X << ",Y:" << (int)m_Y << ",TargetX:" << (int)m_TargetX
