...
CGSkillToTile::CGSkillToTile() throw() {
    __BEGIN_TRY
    __END_CATCH
}
...
void CGSkillToTile::read(SocketInputStream& iStream) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGSkillToTile::write(SocketOutputStream& oStream) const throw(ProtocolException, Error) {
    __BEGIN_TRY
#ifdef __USE_ENCRYPTER__
...
void CGSkillToTile::execute(Player* pPlayer) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
string CGSkillToTile::toString() const throw() {
    __BEGIN_TRY
    StringStream msg;
