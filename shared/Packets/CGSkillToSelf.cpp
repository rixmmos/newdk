...
CGSkillToSelf::CGSkillToSelf() throw() {
    __BEGIN_TRY
    __END_CATCH
}
...
void CGSkillToSelf::read(SocketInputStream& iStream) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
void CGSkillToSelf::write(SocketOutputStream& oStream) const throw(ProtocolException, Error) {
    __BEGIN_TRY
#ifdef __USE_ENCRYPTER__
...
void CGSkillToSelf::execute(Player* pPlayer) throw(ProtocolException, Error) {
    __BEGIN_TRY
...
string CGSkillToSelf::toString() const throw() {
    __BEGIN_TRY
    StringStream msg;
