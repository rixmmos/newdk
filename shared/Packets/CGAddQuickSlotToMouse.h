...
public:
    ...
    PacketID_t getPacketID() const {
        return PACKET_CG_ADD_QUICKSLOT_TO_MOUSE;
    }
    PacketSize_t getPacketSize() const {
        return szObjectID + szSlotID;
    }
    string getPacketName() const {
        return "CGAddQuickSlotToMouse";
    }
...
public:
    ...
    Packet* createPacket() throw() {
        return new CGAddQuickSlotToMouse();
    }
    string getPacketName() const throw() {
        return "CGAddQuickSlotToMouse";
    }
    PacketID_t getPacketID() const throw() {
        return Packet::PACKET_CG_ADD_QUICKSLOT_TO_MOUSE;
    }
...
// Server-only: CGAddQuickSlotToMouseHandler::execute has no client-side definition
