...
void CLQueryPlayerID::read(SocketInputStream& iStream) throw(ProtocolException, Error)
...
void CLQueryPlayerID::write(SocketOutputStream& oStream) const throw(ProtocolException, Error)
...
void CLQueryPlayerID::execute(Player* pPlayer) throw(ProtocolException, Error)
...
string CLQueryPlayerID::toString() const throw()
