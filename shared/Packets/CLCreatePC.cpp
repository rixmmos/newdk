...
void CLCreatePC::read(SocketInputStream& iStream) throw(ProtocolException, Error)
...
void CLCreatePC::write(SocketOutputStream& oStream) const throw(ProtocolException, Error)
...
void CLCreatePC::execute(Player* pPlayer) throw(ProtocolException, Error)
...
string CLCreatePC::toString() const throw()
