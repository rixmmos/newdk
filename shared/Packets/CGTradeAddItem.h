...
public:
    CGTradeAddItem() throw() {}
    virtual ~CGTradeAddItem() throw() {}
...
public:
    ...
    void setTargetObjectID(ObjectID_t id) throw() {
        m_TargetObjectID = id;
    }
    ...
    void setItemObjectID(ObjectID_t id) throw() {
        m_ItemObjectID = id;
    }
