...
void CLQueryCharacterName::read(SocketInputStream& iStream) throw(ProtocolException, Error)
...
void CLQueryCharacterName::write(SocketOutputStream& oStream) const throw(ProtocolException, Error)
...
void CLQueryCharacterName::execute(Player* pPlayer) throw(ProtocolException, Error)
...
string CLQueryCharacterName::toString() const throw()
