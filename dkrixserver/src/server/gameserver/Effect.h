...
public:
    enum EffectClass {
        ...
        // by sigi. 2002.11.7
        EFFECT_CLASS_TRANSPORT_CREATURE, 
        ...
        EFFECT_CLASS_SHRINE_GUARD_WARP,     
        EFFECT_CLASS_SHRINE_HOLY_WARP,      
        ...
        EFFECT_CLASS_WARP_BLOOD_BIBLE_FROM_ME,   
        EFFECT_CLASS_WARP_BLOOD_BIBLE_FROM_TILE, 

        EFFECT_CLASS_WARP_HOLY_LAND_VAMPIRE, 
        EFFECT_CLASS_WARP_HOLY_LAND_SLAYER,  
        ...
        EFFECT_CLASS_MAGIC_ELUSION,      
        EFFECT_CLASS_POISON_MESH,        
        EFFECT_CLASS_ILLUSION_OF_AVENGE, 
        EFFECT_CLASS_WILL_OF_LIFE,       
        ...
        EFFECT_CLASS_WARP_HOLY_LAND_OUSTERS, 
        EFFECT_CLASS_FAMILY_BONUS,           
        ...
        EFFECT_CLASS_TRAP_TRIGGERED, 
        EFFECT_CLASS_TRAPPED,        
        ...
        EFFECT_CLASS_SIEGE_DEFENDER,  
        EFFECT_CLASS_SIEGE_REINFORCE, 

        EFFECT_CLASS_SIEGE_ATTACKER_1, 
        EFFECT_CLASS_SIEGE_ATTACKER_2, 
        EFFECT_CLASS_SIEGE_ATTACKER_3, 
        EFFECT_CLASS_SIEGE_ATTACKER_4, 
        EFFECT_CLASS_SIEGE_ATTACKER_5, 

        EFFECT_CLASS_SHARE_HP, 

        EFFECT_CLASS_LAND_MINE_EXPLOSION, 
        EFFECT_CLASS_CLAYMORE_EXPLOTION,  
        EFFECT_CLASS_PLEASURE_EXPLOSION,  
        EFFECT_CLASS_TURRET_LASER,        
        EFFECT_CLASS_TURRET_LASER_ATTACK, 
        EFFECT_CLASS_AUTO_TURRET,         

        EFFECT_CLASS_HIDE_TO_ATTACKER, 

        EFFECT_CLASS_REPUTO_FACTUM,      // 427
        EFFECT_CLASS_REPUTO_FACTUM_LAST, 

        EFFECT_CLASS_SWORD_OF_THOR, 
        ...
        EFFECT_CLASS_BLOOD_BLLODY_SCARIFY,           
        EFFECT_CLASS_BLOOD_CURSE,                    
        EFFECT_CLASS_SKILL_BOMB_CRASH_WALK_TO_ENEMY, // 465
        EFFECT_CLASS_SKILL_SATELLITE_BOMB_AIM,       
        EFFECT_CLASS_SKILL_SATELLITE_BOMB_POINT,     
        EFFECT_CLASS_SKILL_SATELLITE_BOMB_FIRE,      
        EFFECT_CLASS_HEAVEN_GROUND,                  
        EFFECT_CLASS_DUMMY_DRAKE,                    
        EFFECT_CLASS_HYDRO_CONVERGENCE,              
        EFFECT_CLASS_SUMMON_CLAY,                    
        EFFECT_CLASS_HETER_CHAKRAM,                  
...
public:
    ...
    virtual EffectClass getSendEffectClass() const {
    ...
    void setBroadcastingEffect(bool bBroadcasting = true) {
        m_bBroadcastingEffect = bBroadcasting;
    }
...
public:
    ...
    Timeval getNextTime() const {
        return m_NextTime;
    }
    void setNextTime(Timeval tv) {
        m_NextTime = tv;
    }
