...
string CommonBillingPacket::toString() const {
    ...
    */
    ...
    memcpy(str, Session, 32);
    str[32] = '\0';
    msg << ",Session=" << str;

    memcpy(str, User_CC, 4);
    str[4] = '\0';
    msg << ",User_CC=" << str;

    memcpy(str, User_No, 20);
    str[20] = '\0';
    msg << ",User_No=" << str;

    memcpy(str, User_ID, 40);
    str[40] = '\0';
    msg << ",User_ID=" << str;

    memcpy(str, User_IP, 24);
    str[24] = '\0';
    msg << ",User_IP=" << str;

    msg << ",Gender=" << (int)User_Gender;

    memcpy(str, User_Status, 3);
    str[3] = '\0';
    msg << ",User_Status=" << str;

    memcpy(str, User_PayType, 2);
    str[2] = '\0';
    msg << ",User_PayType=" << str;

    msg << ",User_Age=" << User_Age << ",Game_No=" << Game_No;

    memcpy(str, Bill_PayType, 2);
    str[2] = '\0';
    msg << ",Bill_PayType=" << str;

    memcpy(str, Bill_Method, 2);
    str[2] = '\0';
    msg << ",Bill_Method=" << str;

    memcpy(str, Expire_Date, 12);
    str[12] = '\0';
    msg << ",Expire_Date=" << str;
