        ...
        if (keyword == "EntranceFee") {
            ...
            if (questLevel == 2) {
                ...
                if (pCreature2->isSlayer()) {
                    ...
                    filelog("EventBug.txt", "ActionAskVariable : 3     .");
                }
                ...
                if (pCreature2->isSlayer()) {
                    ...
                    filelog("EventBug.txt", "ActionAskVariable : 4     .");
                }
            } else {
                filelog("EventBug.txt", "ActionAskVariable :      . %d", questLevel);
                Assert(false);
            }
            ...
            if (questLevel == 2) {
                ...
                filelog("EventBug.txt", "ActionAskVariable :      . %d",
                        questLevel);
                Assert(false);
            }
