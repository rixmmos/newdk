...
public:
    virtual ConditionType_t getConditionType() const {
        return CONDITION_HAS_ENOUGH_CASTLE_ENTRANCE_FEE;
    }
...
public:
    virtual ConditionType_t getConditionType() const {
        return Condition::CONDITION_HAS_ENOUGH_CASTLE_ENTRANCE_FEE;
    }
    virtual Condition* createCondition() const {
        return new ConditionHasEnoughCastleEntranceFee();
    }
    virtual string getConditionName() const {
        return "HasEnoughCastleEntranceFee";
    }
};
