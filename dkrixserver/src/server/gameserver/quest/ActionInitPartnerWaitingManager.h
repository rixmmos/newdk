...
public:
    virtual ActionType_t getActionType() const {
        return ACTION_INIT_PARTNER_WAITING_MANAGER;
    }
...
public:
    virtual ActionType_t getActionType() const {
        return Action::ACTION_INIT_PARTNER_WAITING_MANAGER;
    }
    virtual string getActionName() const {
        return "InitPartnerWaitingManager";
    }
    virtual Action* createAction() const {
        return new ActionInitPartnerWaitingManager();
    }
};
#endif
