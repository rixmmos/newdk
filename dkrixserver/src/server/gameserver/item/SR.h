...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_SR; }
    //	virtual string getObjectTableName() const  { return "SRObject"; }
...
public:
    ...
    void setToHitBonus(ToHit_t tohit) {
        m_ToHitBonus = tohit;
    }
...
public:
    virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) {
        return new SR(ItemType, OptionType);
    }
};
