//////////////////////////////////////////////////////////////////////////////
// Filename    : VampireAmulet.h
// Written By  : Elca
// Description :
//////////////////////////////////////////////////////////////////////////////

#ifndef __VAMPIRE_AMULET_H__
#define __VAMPIRE_AMULET_H__
...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_VAMPIRE_AMULET; }
    //	virtual string getObjectTableName() const  { return "VampireAmuletObject"; }
...
//////////////////////////////////////////////////////////////////////////////
// class VampireAmuletInfo
//////////////////////////////////////////////////////////////////////////////

class VampireAmuletInfo : public ItemInfo {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_VAMPIRE_AMULET;
    }
...
//////////////////////////////////////////////////////////////////////////////
// class VampireAmuletInfoManager;
//////////////////////////////////////////////////////////////////////////////

class VampireAmuletInfoManager : public InfoClassManager {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_VAMPIRE_AMULET;
    }
...
extern VampireAmuletInfoManager* g_pVampireAmuletInfoManager;


//////////////////////////////////////////////////////////////////////////////
// class VampireAmuletFactory
//////////////////////////////////////////////////////////////////////////////

class VampireAmuletFactory : public ItemFactory {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_VAMPIRE_AMULET;
    }
    virtual string getItemClassName() const {
        return "VampireAmulet";
    }

public:
    virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) {
        return new VampireAmulet(ItemType, OptionType);
    }
};


//////////////////////////////////////////////////////////////////////////////
// class VampireAmuletLoader;
//////////////////////////////////////////////////////////////////////////////

class VampireAmuletLoader : public ItemLoader {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_VAMPIRE_AMULET;
    }
...
extern VampireAmuletLoader* g_pVampireAmuletLoader;
