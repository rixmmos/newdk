...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_SHIELD; }
    //	virtual string getObjectTableName() const  { return "ShieldObject"; }
...
public:
    virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) {
        return new Shield(ItemType, OptionType);
    }
};
