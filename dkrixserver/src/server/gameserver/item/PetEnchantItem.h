...
public:
    virtual ItemClass getItemClass() const {
        return Item::ITEM_CLASS_PET_ENCHANT_ITEM;
    }
    virtual string getObjectTableName() const {
        return "PetEnchantItemObject";
    }
...
public:
    ...
    BYTE getFunctionGrade() const {
        return m_FunctionGrade;
    }
    void setFunctionGrade(BYTE Grade) {
        m_FunctionGrade = Grade;
    }
