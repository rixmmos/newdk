...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_OUSTERS_COAT; }
    //	virtual string getObjectTableName() const  { return "OustersCoatObject"; }
...
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_OUSTERS_COAT;
    }
...
public:
    virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) {
        return new OustersCoat(ItemType, OptionType);
    }
};
