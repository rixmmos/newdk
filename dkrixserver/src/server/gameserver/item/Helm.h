...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_HELM; }
    //	virtual string getObjectTableName() const  { return "HelmObject"; }
...
extern HelmInfoManager* g_pHelmInfoManager;
