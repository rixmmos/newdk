...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_COAT; }
    //	virtual string getObjectTableName() const  { return "CoatObject"; }
...
public:
    virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) {
        return new Coat(ItemType, OptionType);
    }
};
