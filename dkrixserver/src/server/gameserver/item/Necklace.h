...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_NECKLACE; }
    //	virtual string getObjectTableName() const  { return "NecklaceObject"; }
...
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_NECKLACE;
    }
...
public:
    virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) {
        return new Necklace(ItemType, OptionType);
    }
};
