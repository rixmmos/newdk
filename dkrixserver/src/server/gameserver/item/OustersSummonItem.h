...
public:
    virtual ItemClass getItemClass() const {
        return Item::ITEM_CLASS_OUSTERS_SUMMON_ITEM;
    }
    virtual string getObjectTableName() const {
        return "OustersSummonItemObject";
    }
...
public:
    ...
    EffectID_t getEffectID(void) const {
        return m_EffectID;
    }
