//////////////////////////////////////////////////////////////////////////////
// Filename    : OustersRing.h
// Written By  :
// Description :
//////////////////////////////////////////////////////////////////////////////

#ifndef __OUSTERS_RING_H__
#define __OUSTERS_RING_H__
...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_OUSTERS_RING; }
    //	virtual string getObjectTableName() const  { return "OustersRingObject"; }
...
//////////////////////////////////////////////////////////////////////////////
// class OustersRingInfo
//////////////////////////////////////////////////////////////////////////////

class OustersRingInfo : public ItemInfo {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_OUSTERS_RING;
    }
...
//////////////////////////////////////////////////////////////////////////////
// class OustersRingInfoManager;
//////////////////////////////////////////////////////////////////////////////

class OustersRingInfoManager : public InfoClassManager {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_OUSTERS_RING;
    }
...
extern OustersRingInfoManager* g_pOustersRingInfoManager;


//////////////////////////////////////////////////////////////////////////////
// class OustersRingFactory
//////////////////////////////////////////////////////////////////////////////

class OustersRingFactory : public ItemFactory {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_OUSTERS_RING;
    }
...
public:
    virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) {
        return new OustersRing(ItemType, OptionType);
    }
};


//////////////////////////////////////////////////////////////////////////////
// class OustersRingLoader;
//////////////////////////////////////////////////////////////////////////////

class OustersRingLoader : public ItemLoader {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_OUSTERS_RING;
    }
...
extern OustersRingLoader* g_pOustersRingLoader;
