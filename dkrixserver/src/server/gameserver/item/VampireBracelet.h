...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_VAMPIRE_BRACELET; }
    //	virtual string getObjectTableName() const  { return "VampireBraceletObject"; }
...
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_VAMPIRE_BRACELET;
    }
