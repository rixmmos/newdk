...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_OUSTERS_CIRCLET; }
    //	virtual string getObjectTableName() const  { return "OustersCircletObject"; }
...
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_OUSTERS_CIRCLET;
    }
