...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_VAMPIRE_COAT; }
    //	virtual string getObjectTableName() const  { return "VampireCoatObject"; }
...
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_VAMPIRE_COAT;
    }
...
public:
    virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) {
        return new VampireCoat(ItemType, OptionType);
    }
};
