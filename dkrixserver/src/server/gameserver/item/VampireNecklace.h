//////////////////////////////////////////////////////////////////////////////
// Filename    : VampireNecklace.h
// Written By  : Elca
// Description :
//////////////////////////////////////////////////////////////////////////////

#ifndef __VAMPIRE_NECKLACE_H__
#define __VAMPIRE_NECKLACE_H__
...
public:
    //	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_VAMPIRE_NECKLACE; }
    //	virtual string getObjectTableName() const  { return "VampireNecklaceObject"; }
...
//////////////////////////////////////////////////////////////////////////////
// class VampireNecklaceInfo
//////////////////////////////////////////////////////////////////////////////

class VampireNecklaceInfo : public ItemInfo {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_VAMPIRE_NECKLACE;
    }
...
//////////////////////////////////////////////////////////////////////////////
// class VampireNecklaceInfoManager;
//////////////////////////////////////////////////////////////////////////////

class VampireNecklaceInfoManager : public InfoClassManager {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_VAMPIRE_NECKLACE;
    }
...
extern VampireNecklaceInfoManager* g_pVampireNecklaceInfoManager;


//////////////////////////////////////////////////////////////////////////////
// class VampireNecklaceFactory
//////////////////////////////////////////////////////////////////////////////

class VampireNecklaceFactory : public ItemFactory {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_VAMPIRE_NECKLACE;
    }
    virtual string getItemClassName() const {
        return "VampireNecklace";
    }

public:
    virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) {
        return new VampireNecklace(ItemType, OptionType);
    }
};


//////////////////////////////////////////////////////////////////////////////
// class VampireNecklaceLoader;
//////////////////////////////////////////////////////////////////////////////

class VampireNecklaceLoader : public ItemLoader {
public:
    virtual Item::ItemClass getItemClass() const {
        return Item::ITEM_CLASS_VAMPIRE_NECKLACE;
    }
...
extern VampireNecklaceLoader* g_pVampireNecklaceLoader;
