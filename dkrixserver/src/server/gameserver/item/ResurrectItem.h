...
public:
    virtual ItemClass getItemClass() const {
        return Item::ITEM_CLASS_RESURRECT_ITEM;
    }
    virtual string getObjectTableName() const {
        return "ResurrectItemObject";
    }
...
public:
    ...
    ResurrectType getResurrectType() const {
        return m_ResurrectType;
    }
    void setResurrectType(ResurrectType type) {
        m_ResurrectType = type;
    }
