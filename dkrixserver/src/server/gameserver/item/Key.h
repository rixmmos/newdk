...
public:
    ItemID_t getTarget() const {
        return m_Target;
    }
    void setTarget(ItemID_t target) {
        m_Target = target;
    }
...
public:
    ...
    ItemType_t getTargetType() const {
        return m_TargetType;
    }
    void setTargetType(ItemType_t target) {
        m_TargetType = target;
    }
...
public:
    virtual Item* createItem(ItemType_t ItemType, const list<OptionType_t>& OptionType) {
        return new Key(ItemType, OptionType);
    }
};
