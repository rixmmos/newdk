...

{
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_VAMPIRE_BRACELET]->getItemClassName()] =
        Item::ITEM_CLASS_VAMPIRE_BRACELET;

    m_Factories[Item::ITEM_CLASS_VAMPIRE_NECKLACE] = new VampireNecklaceFactory();
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_VAMPIRE_NECKLACE]->getItemClassName()] =
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_SLAYER_PORTAL_ITEM]->getItemClassName()] =
        Item::ITEM_CLASS_SLAYER_PORTAL_ITEM;

    m_Factories[Item::ITEM_CLASS_VAMPIRE_PORTAL_ITEM] = new VampirePortalItemFactory();
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_VAMPIRE_PORTAL_ITEM]->getItemClassName()] =
        Item::ITEM_CLASS_VAMPIRE_PORTAL_ITEM;
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_VAMPIRE_EARRING]->getItemClassName()] =
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_VAMPIRE_COUPLE_RING]->getItemClassName()] =
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_OUSTERS_ARMSBAND]->getItemClassName()] =
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_OUSTERS_CHAKRAM]->getItemClassName()] =
        Item::ITEM_CLASS_OUSTERS_CHAKRAM;

    m_Factories[Item::ITEM_CLASS_OUSTERS_CIRCLET] = new OustersCircletFactory();
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_OUSTERS_CIRCLET]->getItemClassName()] =
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_OUSTERS_PENDENT]->getItemClassName()] =
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_OUSTERS_WRISTLET]->getItemClassName()] =
        Item::ITEM_CLASS_OUSTERS_WRISTLET;
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_OUSTERS_SUMMON_ITEM]->getItemClassName()] =
        Item::ITEM_CLASS_OUSTERS_SUMMON_ITEM;
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_PET_ENCHANT_ITEM]->getItemClassName()] =
        Item::ITEM_CLASS_PET_ENCHANT_ITEM;
    ...
    m_ItemClassMap[m_Factories[Item::ITEM_CLASS_CARRYING_RECEIVER]->getItemClassName()] =
        Item::ITEM_CLASS_CARRYING_RECEIVER;
