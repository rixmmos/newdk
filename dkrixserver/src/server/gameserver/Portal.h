...
public:
    virtual ObjectClass getObjectClass() const {
        return OBJECT_CLASS_PORTAL;
    }
    virtual ObjectPriority getObjectPriority() const {
        return OBJECT_PRIORITY_PORTAL;
    }
    virtual PortalClass getPortalClass() const = 0;
    virtual bool activate(Creature* pCreature) {
        return false;
    };
    virtual bool activate(Creature* pCreature, ZoneID_t ZoneID) {
        return false;
    };
    virtual string toString() const = 0;

public:
    PortalType_t getObjectType() const {
        return m_PortalType;
    }
    void setObjectType(PortalType_t portalType) {
...
public:
    PortalClass getPortalClass() const {
        return PORTAL_CLASS_PRIVATE;
    }
...
public:
    ...
    // get Portal class
    PortalClass getPortalClass() const {
        return PORTAL_CLASS_MULTI;
    }

    void setPortalTargetInfo(PortalTargetInfo* pPortalTargetInfo) {
        m_Targets.push_back(pPortalTargetInfo);
    }
