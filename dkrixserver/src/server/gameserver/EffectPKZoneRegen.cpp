...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
EffectPKZoneRegen::EffectPKZoneRegen(Zone* pZone, ZoneCoord_t left, ZoneCoord_t top, ZoneCoord_t right,
                                     ZoneCoord_t bottom)
    ...
    if (m_bSlayer && pCreature->isSlayer()) {
        ...
        if (pSlayer->getHP(ATTR_CURRENT) >= pSlayer->getHP(ATTR_MAX) &&
            ...
            EffectBloodDrain* pEffect =
                dynamic_cast<EffectBloodDrain*>(pSlayer->findEffect(Effect::EFFECT_CLASS_BLOOD_DRAIN));
            if (pEffect != NULL) {
        ...
        if (pOusters->getHP(ATTR_CURRENT) < pOusters->getHP(ATTR_MAX) ||
            pOusters->getMP(ATTR_CURRENT) < pOusters->getMP(ATTR_MAX) || pOusters->getSilverDamage() != 0) {
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
string EffectPKZoneRegen::toString() const {
    __BEGIN_TRY
