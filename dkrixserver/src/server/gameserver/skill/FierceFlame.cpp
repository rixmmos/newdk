...
//////////////////////////////////////////////////////////////////////////////
void FierceFlame::execute(Ousters* pOusters, ObjectID_t TargetObjectID, OustersSkillSlot* pOustersSkillSlot,
...

{
    ...
    try {
        ...
        if (pItem == NULL || pItem->getItemClass() != Item::ITEM_CLASS_OUSTERS_WRISTLET ||
