...
//////////////////////////////////////////////////////////////////////////////
void ChoppingFirewood::execute(Monster* pMonster, ZoneCoord_t X, ZoneCoord_t Y)

{
    ...
    try {
        ...
        SkillType_t SkillType = SKILL_CHOPPING_FIREWOOD;
        ...
        X = pMonster->getX() + dirMoveMask[dir].x * 2;
        Y = pMonster->getY() + dirMoveMask[dir].y * 2;
...
ChoppingFirewood g_ChoppingFirewood;
