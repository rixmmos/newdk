                ...
                if (pObject->getObjectClass() == Object::OBJECT_CLASS_CREATURE) {
                    ...
                    if (pCreature->getMoveMode() != Creature::MOVE_MODE_FLYING) {
                        ...
                        if (pCreature->isSlayer()) {
                            ...
                            ::setDamage(pSlayer, damage, pCastCreature, SKILL_Rapid_Freeze, &gcDefenderMI,
                            ...
                            ::setDamage(pVampire, damage, pCastCreature, SKILL_Rapid_Freeze, &gcDefenderMI,
                                        &gcAttackerMI, true, false);
                            ...
                            ::setDamage(pMonster, damage, pCastCreature, SKILL_Rapid_Freeze, NULL, &gcAttackerMI, true,
                                        false);
                        } else
                            continue; 
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
string EffectRapidFreeze::toString() const throw() {
    __BEGIN_TRY
