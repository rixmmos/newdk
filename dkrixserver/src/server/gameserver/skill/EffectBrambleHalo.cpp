        ...
        for (int y = -1; y <= 1; y++) {
            ...
            if (tile.hasCreature(Creature::MOVE_MODE_WALKING)) {
                ...
                if (pCreature->isVampire() || pCreature->isOusters()) {
                    ...
                    ::setDamage(pCreature, m_Damage, pCastCreature, SKILL_Bramble_Halo, &gcMI, &gcAttackerMI);
                    ...
                    ::setDamage(pMonster, m_Damage, pCastCreature, SKILL_Bramble_Halo, NULL, &gcAttackerMI);
...
void EffectBrambleHalo::setLevel(SkillLevel_t Level) {
    if (Level <= GRADE_ADEPT_LIMIT_LEVEL)
        m_EffectClass = EFFECT_CLASS_Bramble_Halo;
    else if (Level <= GRADE_EXPERT_LIMIT_LEVEL)
        m_EffectClass = EFFECT_CLASS_Bramble_Halo;
    else if (Level <= GRADE_MASTER_LIMIT_LEVEL)
        m_EffectClass = EFFECT_CLASS_Bramble_Halo;
    else
        m_EffectClass = EFFECT_CLASS_Bramble_Halo;
}
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
string EffectBrambleHalo::toString() const throw() {
    __BEGIN_TRY
