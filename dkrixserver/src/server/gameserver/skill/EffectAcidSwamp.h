...
public:
    EffectClass getEffectClass() const throw() {
        return EFFECT_CLASS_ACID_SWAMP;
    }
...
public:
    ...
    ObjectID_t getBurrowingTargetObjectID() const {
        return m_TargetObjectID[0];
    }
    void setBurrowingTargetObjectID(ObjectID_t oid) {
        m_TargetObjectID[0] = oid;
    }

    ObjectID_t getWalkingTargetObjectID() const {
        return m_TargetObjectID[1];
    }
    void setWalkingTargetObjectID(ObjectID_t oid) {
        m_TargetObjectID[1] = oid;
    }
...
public:
    virtual Effect::EffectClass getEffectClass() const throw() {
        return Effect::EFFECT_CLASS_ACID_SWAMP;
    }
    virtual string getEffectClassName() const throw() {
        return "EffectAcidSwamp";
    }
