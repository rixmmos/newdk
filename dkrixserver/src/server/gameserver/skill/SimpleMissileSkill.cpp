...
void SimpleMissileSkill::execute(Slayer* pSlayer, ObjectID_t TargetObjectID, SkillSlot* pSkillSlot,
...
void SimpleMissileSkill::execute(Vampire* pVampire, ObjectID_t TargetObjectID, VampireSkillSlot* pVampireSkillSlot,
                                 const SIMPLE_SKILL_INPUT& param, SIMPLE_SKILL_OUTPUT& result, CEffectID_t CEffectID,
                                 int HitBonus)
    ...
    try {
        ...
        if (bManaCheck && bTimeCheck && bRangeCheck && bHitRoll && bCanHit && bPK) {
            ...
            if (bCanSeeCaster) {
                ...
                setDamage(pTargetCreature, Damage, pVampire, param.SkillType, &_GCSkillToObjectOK6,
                          &_GCSkillToObjectOK1);
...
void SimpleMissileSkill::execute(Ousters* pOusters, ObjectID_t TargetObjectID, OustersSkillSlot* pOustersSkillSlot,
                                 const SIMPLE_SKILL_INPUT& param, SIMPLE_SKILL_OUTPUT& result, CEffectID_t CEffectID,
                                 int HitBonus)

{
    ...
    try {
        ...
        if (bManaCheck && bTimeCheck && bRangeCheck && bHitRoll && bCanHit && bPK && bSatisfyRequire) {
            ...
            if (bCanSeeCaster) {
                setDamage(pTargetCreature, Damage, pOusters, param.SkillType, &_GCSkillToObjectOK2,
                          &_GCSkillToObjectOK1);
                ...
                setDamage(pTargetCreature, Damage, pOusters, param.SkillType, &_GCSkillToObjectOK6,
                          &_GCSkillToObjectOK1);
...
void SimpleMissileSkill::execute(Monster* pMonster, Creature* pEnemy, const SIMPLE_SKILL_INPUT& param,
