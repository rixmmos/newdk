...

{
    ...
    try {
        ...
        if (bManaCheck && bTimeCheck && bRangeCheck && bHitRoll && !bEffected) {
            ...
            pPassingHeal->setPassingCount(output.Range);
            pPassingHeal->setCureCount(output.Range);
            pPassingHeal->setHealPoint(output.Damage);
...

{
    ...
    try {
        ...
        bool bHitRoll = HitRoll::isSuccessMagic(pSlayer, pSkillInfo, pSkillSlot);
        bool bEffected = pSlayer->isFlag(Effect::EFFECT_CLASS_PASSING_HEAL);
