            ...
            for (; itr != oList.end(); itr++) {
                ...
                if (pObject->getObjectClass() == Object::OBJECT_CLASS_CREATURE) {
                    ...
                    if (pCreature->isSlayer()) {
                        ...
                        ::setDamage(pSlayer, Damage, pCastCreature, SKILL_METEOR_STRIKE, &gcSkillToObjectOK2,
                                    &gcAttackerMI);
                        ...
                        ::setDamage(pVampire, Damage, pCastCreature, SKILL_METEOR_STRIKE, &gcSkillToObjectOK2,
                                    &gcAttackerMI);
                        ...
                        ::setDamage(pOusters, Damage, pCastCreature, SKILL_METEOR_STRIKE, &gcSkillToObjectOK2,
                                    &gcAttackerMI);
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
string EffectMeteorStrike::toString() const throw() {
    __BEGIN_TRY
