//////////////////////////////////////////////////////////////////////////////
// Filename    : BrambleHalo.cpp
// Written by  :
// Description :
//////////////////////////////////////////////////////////////////////////////

#include "BrambleHalo.h"
...

{
    ...
    try {
        ...
        bool bEffected = pSlayer->isFlag(Effect::EFFECT_CLASS_Bramble_Halo);
        ...
        if (bManaCheck && bTimeCheck && bRangeCheck && bHitRoll && !bEffected) {
            ...
            EffectBrambleHalo* pEffect = new EffectBrambleHalo(pSlayer);
            ...
            pSlayer->setFlag(Effect::EFFECT_CLASS_Bramble_Halo);
