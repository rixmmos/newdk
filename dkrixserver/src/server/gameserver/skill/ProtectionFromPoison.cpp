//////////////////////////////////////////////////////////////////////////////
// Filename    : ProtectionFromPoison.cpp
// Written by  : excel96
// Description :
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
void ProtectionFromPoison::execute(Slayer* pSlayer, ObjectID_t TargetObjectID, SkillSlot* pSkillSlot,
...

{
    ...
    try {
        ...
        bool bEffected = pTargetCreature->isFlag(Effect::EFFECT_CLASS_PROTECTION_FROM_POISON);
        ...
        if (bManaCheck && bTimeCheck && bRangeCheck && bHitRoll && !bEffected) {
            ...
            EffectProtectionFromPoison* pEPFP = new EffectProtectionFromPoison(pTargetCreature);
            Assert(pEPFP != NULL);
            pEPFP->setDeadline(output.Duration);
            pEPFP->setResist(output.Damage);
            pTargetCreature->addEffect(pEPFP);
            pTargetCreature->setFlag(Effect::EFFECT_CLASS_PROTECTION_FROM_POISON);
            ...
            gcAddEffect.setEffectID(Effect::EFFECT_CLASS_PROTECTION_FROM_POISON);
...

{
    ...
    try {
        ...
        bool bHitRoll = HitRoll::isSuccessMagic(pSlayer, pSkillInfo, pSkillSlot);
        bool bEffected = pSlayer->isFlag(Effect::EFFECT_CLASS_PROTECTION_FROM_POISON);
        ...
        if (bManaCheck && bTimeCheck && bRangeCheck && bHitRoll && !bEffected) {
            ...
            EffectProtectionFromPoison* pEPFP = new EffectProtectionFromPoison(pSlayer);
            pEPFP->setDeadline(output.Duration);
            pEPFP->setResist(output.Damage);
            pSlayer->addEffect(pEPFP);
            pSlayer->setFlag(Effect::EFFECT_CLASS_PROTECTION_FROM_POISON);
...
ProtectionFromPoison g_ProtectionFromPoison;
