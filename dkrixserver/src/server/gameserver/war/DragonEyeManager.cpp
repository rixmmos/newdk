...

{
    ...
    m_DefaultPositions[0].set(73, 24, 121);  
    m_DefaultPositions[1].set(1201, 62, 68); 
    m_DefaultPositions[2].set(1203, 85, 50); 
    m_DefaultPositions[3].set(71, 111, 124); 
    m_DefaultPositions[4].set(1204, 62, 69); 
    m_DefaultPositions[5].set(1202, 81, 52); 
    m_DefaultPositions[6].set(72, 66, 168);  
    m_DefaultPositions[7].set(1205, 62, 69); 
    m_DefaultPositions[8].set(1206, 82, 52); 
