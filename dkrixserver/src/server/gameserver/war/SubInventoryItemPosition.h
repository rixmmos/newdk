...
public:
    SubInventoryItemPosition() : GlobalItemPosition(POS_TYPE_SUB_INVENTORY) {
        m_bSetZone = false;
    }
...
public:
    ...
    ItemID_t getSubInventoryID() const {
        return m_SubInventoryID;
    }
    void setSubInventoryID(ItemID_t subInventoryID) {
        m_SubInventoryID = subInventoryID;
    }

    CoordInven_t getInventoryX() const {
        return m_InvenX;
    }
    void setInventoryX(CoordInven_t invenX) {
        m_bSetZone = false;
        m_InvenX = invenX;
    }

    CoordInven_t getInventoryY() const {
        return m_InvenY;
    }
    void setInventoryY(CoordInven_t invenY) {
        m_bSetZone = false;
        m_InvenY = invenY;
    }
