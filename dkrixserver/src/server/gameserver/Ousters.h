...
public:
    ...
    SkillBonus_t getSkillBonus() const {
        return m_SkillBonus;
    }
...
public:
    ...
    OustersSkillSlot* hasSkill(SkillType_t SkillType) const {
...
public:
    ...
    Elemental_t getElementalWater() const {
        return m_ElementalWater;
    }
    Elemental_t getElementalEarth() const {
        return m_ElementalEarth;
    }
    Elemental_t getElementalWind() const {
        return m_ElementalWind;
    }
    Elemental_t getElementalSum() const {
        return m_ElementalFire + m_ElementalWater + m_ElementalEarth + m_ElementalWind;
    }
    ...
    Damage_t getWaterDamage() const {
        return m_WaterDamage;
    }
    Damage_t getEarthDamage() const {
        return m_EarthDamage;
    }

    Resist_t getSilverResist() const {
        return m_SilverResist;
    }
    ...
    uint getPassiveBonus(SkillType_t type) {
        return (m_PassiveSkillMap.find(type) != m_PassiveSkillMap.end()) ? m_PassiveSkillMap[type].second : 0;
    }
    int getPassiveRatio() const {
        return m_PassiveRatio;
    }
