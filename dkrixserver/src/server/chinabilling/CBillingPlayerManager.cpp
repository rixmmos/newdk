        ...
        while (true) {
            ...
            if (m_pCBillingPlayer == NULL) {
                ...
                try {
                    ...
                    cout << "connection to china billing server established - " << CBillingServerIP.c_str() << ":"
                         << CBillingServerPort << endl;
                    ...
                    cout << "connect to china billing server fail - " << CBillingServerIP.c_str() << ":"
                         << CBillingServerPort << endl;
                    filelog(LOGFILE_CBILLING_PLAYER, "connect failed(%s:%d)", CBillingServerIP.c_str(),
                            CBillingServerPort);
