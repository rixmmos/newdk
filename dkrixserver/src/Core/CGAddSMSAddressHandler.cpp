...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void CGAddSMSAddressHandler::execute(CGAddSMSAddress* pPacket, Player* pPlayer) throw(ProtocolException, Error)

{
    ...
    SMSAddressElement* pElement = new SMSAddressElement(pBook->popNextEID(), pPacket->getCharacterName(),
                                                        pPacket->getCustomName(), pPacket->getNumber());
