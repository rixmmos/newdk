...
void CGSayHandler::opExecute(Creature* pCreature, GamePlayer* pGamePlayer, string msg, int i) {
    ...
    */
    ...
    // Parenthesised so isGOD() actually gates the command. `&&` binds tighter
    // than `||`, so the original parsed as (=="find") || ("" && isGOD()) -- the
    // privilege check applied only to the dead empty-string arm and any player
    // could run *find. The other 34 commands in this dispatcher use the correct
    // `&&` form; these three were typos.
    ...
    // Same precedence fix as *find above: any player could toggle the pay-zone
    // portal flag for everyone in zone 1013.
    else if ((msg.substr(i + 1, 10) == "OpenPayMap" || msg.substr(i + 1, 12) == "") && pCreature->isGOD()) {
        ...
        // Same precedence fix as *find / *OpenPayMap above.
    } else if ((msg.substr(i + 1, 11) == "ClosePayMap" || msg.substr(i + 1, 12) == "") && pCreature->isGOD()) {
        ZoneInfo* pZoneInfo = g_pZoneInfoManager->getZoneInfo(1013);
...
void CGSayHandler::opview(GamePlayer* pGamePlayer, string msg, int i) {
    ...
    if (set_type == "star") {
        ...
        message << " 1/" << g_pVariableManager->getEventRatio();
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "exp_ratio") {
        message << ": " << g_pVariableManager->getExpRatio();
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "item_prob_ratio") {
        message << ": " << g_pVariableManager->getItemProbRatio();
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "combat_bonus_time") {
        message << ": " << g_pVariableManager->getCombatBonusTime() << "";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "combat_bonus_slayer_hp_ratio") {
        message << " HP: +" << g_pVariableManager->getCombatSlayerHPBonusRatio() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "combat_bonus_vampire_hp_ratio") {
        message << " HP: +" << g_pVariableManager->getCombatVampireHPBonusRatio() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "combat_bonus_slayer_damage") {
        message << " Damage: +" << g_pVariableManager->getCombatSlayerDamageBonus();
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "combat_bonus_vampire_damage") {
        message << " Damage: +" << g_pVariableManager->getCombatVampireDamageBonus();
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "premium_exp_bonus_percent") {
        message << ": " << g_pVariableManager->getPremiumExpBonusPercent() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "premium_item_probe_percent") {
        message << ": " << g_pVariableManager->getPremiumItemProbePercent() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "zone_group_balancing_minute") {
        message << "ZoneGroupBalancing: " << g_pVariableManager->getZoneGroupBalancingMinute() << "";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "zone_group_next_balancing_time") {
        const Timeval& tv = g_pClientManager->getBalanceZoneGroupTime();
        Timeval currentTime;
        getCurrentTime(currentTime);
        message << "ZoneGroupBalancing: " << (tv.tv_sec - currentTime.tv_sec) / 60 << "";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "gamble_item_type_ratio") {
        message << "ItemType: " << g_pVariableManager->getGambleItemTypeRatio() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "gamble_item_option_ratio") {
        message << "ItemOption: " << g_pVariableManager->getGambleItemOptionRatio() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "summon_motorcycle") {
        message << " : " << (g_pVariableManager->isSummonMotorcycle() ? "ON" : "OFF");
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "enemy_limit_time") {
        message << ": " << g_pVariableManager->getEnemyLimitTime() << "";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "rare_item_ratio") {
        message << ": " << g_pVariableManager->getRareItemRatio() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "unique_item_ratio") {
        message << ": " << g_pVariableManager->getUniqueItemRatio() << "/10000";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "active_master_lair") {
        message << " : " << (g_pVariableManager->isActiveMasterLair() ? "ON" : "OFF");
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "retry_master_lair") {
        message << ", : " << (g_pVariableManager->isRetryMasterLair() ? "ON" : "OFF");
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "harvest_festival_item_ratio") {
        message << ": 1/" << g_pVariableManager->getHarvestFestivalItemRatio();
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "master_blood_drain_start_hp") {
        message << "HP: " << g_pVariableManager->getMasterBloodDrainStartHP() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "master_blood_drain_start_bd") {
        message << ": " << g_pVariableManager->getMasterBloodDrainStartBD() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "master_blood_drain_end_hp") {
        message << "(?)HP: " << g_pVariableManager->getMasterBloodDrainEndHP() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "master_blood_drain_end_bd") {
        message << "(?): " << g_pVariableManager->getMasterBloodDrainEndBD() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "chief_monster") {
        message << "BOSS : " << (g_pVariableManager->isActiveChiefMonster() ? "ON" : "OFF");
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "chief_monster_rare_item_percent") {
        message << "BOSS: " << g_pVariableManager->getChiefMonsterRareItemPercent() << "%";
        gcSystemMessage.setMessage(message.toString());
    } else if (set_type == "newbie_transport_to_guild") {
        message << "40:" << (g_pVariableManager->isNewbieTransportToGuild() ? "ON" : "OFF");
        gcSystemMessage.setMessage(message.toString());
    } else {
        // by sigi. 2002.11.19
...
void CGSayHandler::opload(GamePlayer* pGamePlayer, string msg, int i) {
    ...
    if (load_type == "master_lair_info") {
        ...
        if (bExist || MonsterName == "all") {
            ...
            if (SpriteType != 0) {
                snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_LOAD_MONSTER_INFO), load_value.c_str());

            } else {
                snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_LOAD_ALL_MONSTER_INFO));
            }
        } else {
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_LOAD_WRONG_MONSTER_INFO), load_value.c_str());
        }
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_LOAD_ITEM_INFO), load_value.c_str());
        gcSystemMessage.setMessage(msg);
...
void CGSayHandler::opset(GamePlayer* pGamePlayer, string msg, int i) {
    ...
    if (set_type == "star") {
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_STAR_RATIO), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_EVENT_MONSTER_RATIO), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_EXP_RATIO), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_ITEM_PROBE_RATIO), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_COMBAT_BONUS_TIME), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_COMBAT_SLAYER_BONUS_HP), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_COMBAT_VAMPIRE_BONUS_HP), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_COMBAT_SLAYER_BONUS_DAMAGE), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_COMBAT_VAMPIRE_BONUS_DAMAGE), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_PREMIUM_EXP_RATIO), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_PREMIUM_ITEM_PROBE_RATIO), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_ZONE_GROUP_BALANCING_TIME), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_GAMBLE_ITEM_TYPE_RATIO), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_GAMBLE_ITEM_OPTION_RATIO), set_value.c_str());
        ...
        if (set_value == "on") {
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_SUMMON_MOTORCYCLE), "ON");
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_SUMMON_MOTORCYCLE), "OFF");
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_MONSTER_FORGET_TIME), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_RARE_ITEM_RATIO), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_UNIQUE_ITEM_RATIO), set_value.c_str());
        ...
        if (set_value == "on") {
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_MASTER_LAIR_ACTIVATE), "ON");
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_MASTER_LAIR_ACTIVATE), "OFF");
        ...
        if (set_value == "on") {
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_RETRY_MASTER_LAIR), "ON");
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_RETRY_MASTER_LAIR), "OFF");
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_HARVEST_FESTIVAL_ITEM_RATIO), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_MASTER_BLOOD_DRAIN_START_HP), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_MASTER_BLOOD_DRAIN_START_BD), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_MASTER_BLOOD_DRAIN_END_HP), set_value.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_MASTER_BLOOD_DRAIN_END_BD), set_value.c_str());
        ...
        if (set_value == "on") {
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_CHIEF_MONSTER), "ON");
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_CHIEF_MONSTER), "OFF");
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_CHIEF_MONSTER_RARE_ITEM_RATIO), set_value.c_str());
        ...
        if (set_value == "on") {
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_NEWBIE_TRANSPORT_TO_GUILD), "ON");
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_SET_NEWBIE_TRANSPORT_TO_GUILD), "OFF");
        ...
        if (vt != VARIABLE_MAX) {
            ...
            if (vt == PREMIUM_HALF_EVENT) {
                ...
                getZoneByZoneID(61)->broadcastPacket(&gcNoticeEvent);
                getZoneByZoneID(64)->broadcastPacket(&gcNoticeEvent);
                getZoneByZoneID(1007)->broadcastPacket(&gcNoticeEvent);
    ...
    if (command == "changeGuildMaster") {
        ...
        BEGIN_DB {
            if (pGuild->getRace() == Guild::GUILD_RACE_SLAYER) {
                PreparedStatement slayerStmt(g_pDatabaseManager->getConnection("DARKEDEN"),
                                             "SELECT Fame, BladeLevel, SwordLevel, GunLevel, HealLevel, EnchantLevel "
                                             "FROM Slayer WHERE Name = ?");
                slayerStmt.bindString(1, master);
                pResult = slayerStmt.execute();
                int i = 0;
                ...
                PreparedStatement vampireStmt(g_pDatabaseManager->getConnection("DARKEDEN"),
                                              "SELECT Level FROM Vampire WHERE Name = ?");
                vampireStmt.bindString(1, master);
                pResult = vampireStmt.execute();
                ...
                PreparedStatement oustersStmt(g_pDatabaseManager->getConnection("DARKEDEN"),
                                              "SELECT Level FROM Ousters WHERE Name = ?");
                oustersStmt.bindString(1, master);
                pResult = oustersStmt.execute();
...
void CGSayHandler::opshutdown(GamePlayer* pGamePlayer, string msg, int i) {
    ...
    if (pGamePlayer != NULL) {
        ...
        try {
            ...
            throw Error("shutdown,zoneGroup.");
        }
...
void CGSayHandler::opdeny(GamePlayer* pGamePlayer, string msg, int i) {
    ...
    PreparedStatement selectStmt(g_pDatabaseManager->getConnection("DARKEDEN"),
                                 "SELECT PlayerID FROM Slayer where Name=?");
    selectStmt.bindString(1, Name);
    ...
    if (pResult->next()) {
        ...
        PreparedStatement updateStmt(g_pDatabaseManager->getConnection("DARKEDEN"),
                                     "UPDATE Player set Access='DENY' where PlayerID =?");
        updateStmt.bindString(1, PlayerID);
        updateStmt.execute();
    }
...
void CGSayHandler::opfind(GamePlayer* pGamePlayer, string msg, int i) {
    ...
    PreparedStatement findStmt(g_pDatabaseManager->getConnection("DARKEDEN"),
                               "SELECT ServerID FROM UserIPInfo where Name=?");
    findStmt.bindString(1, Name);
    Result* pResult = findStmt.execute();
    ...
    if (pResult->getRowCount() != 0) {
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_PLAYER_IN_GAMESERVER), Name.c_str(), ServerName.c_str());
        ...
        char msg[100];
        snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_PLAYER_NOT_IN_GAMESERVER), Name.c_str());
...
void CGSayHandler::opuser(GamePlayer* pGamePlayer, string msg, int i) {
    ...
    char msg[100];
    snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_CURRENT_NUMBER_OF_PLAYER), GroupCount);
...
void CGSayHandler::opsummon(GamePlayer* pGamePlayer, string msg, int i) {
    ...
    size_t v = msg.find_first_of(']', i + 1);
    ...
    } else if (strstr(MonsterName.c_str(), "") != NULL) {
...
void CGSayHandler::opcommand(GamePlayer* pGamePlayer, string msg, int i) {
    ...
    if (command == "balanceZoneGroup") {
        ...
        if (value1 == "on") {
            char msg[50];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_INVINCIBLE), "ON");
            ...
            char msg[50];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_INVINCIBLE), "OFF");
        ...
        if (value1 == "on") {
            char msg[50];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_GHOST), "ON");
            ...
            char msg[50];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_GHOST), "OFF");
        ...
        if (g_pWarSystem->removeWar(zoneID)) {
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_GUILD_WAR_REMOVED), (int)zoneID);
            gcSystemMessage.setMessage(msg);
        } else {
            //			StringStream msg;

            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->c_str(STRID_NO_GUILD_WAR_IN_ACTIVE), (int)zoneID);
            gcSystemMessage.setMessage(msg);
        }
        bSendPacket = true;
        ...
        if (pGamePlayer != NULL) {
            ...
            char msg[100];
            snprintf(msg, sizeof(msg), g_pStringPool->getString(STRID_PC_NUM).c_str(), num);
            gcSystemMessage.setMessage(msg);
        }
            ...
            if (pNick == NULL) {
                ...
                BEGIN_DB {
                    PreparedStatement deleteStmt(g_pDatabaseManager->getConnection("DARKEDEN"),
                                                 "DELETE FROM NicknameBook WHERE OwnerID=? AND nID=100");
                    deleteStmt.bindString(1, pPC->getName());
                    deleteStmt.execute();
                }
                END_DB(pStmt)
    ...
    // }
        ...
        char buffer[200];
        sprintf(buffer, " %u,  %u,  %u", num[RACE_SLAYER], num[RACE_VAMPIRE], num[RACE_OUSTERS]);
        gcSystemMessage.setMessage(buffer);
...
void CGSayHandler::oplog(GamePlayer* pPlayer, string msg, int i) {
    ...
    if (pTargetGamePlayer->startPacketLog(sec)) {
        char msg[100];
        snprintf(msg, sizeof(msg), "%sPacketLog(%u)", name.c_str(), sec);
