...
public:
    ...
    void setName(const string& GuildName) {
        m_Name = GuildName;
    }
    ...
    WORD getGuildMemberInfoListNum() const {
        return m_GuildMemberInfoList.size();
    }

    // add GuildMemberInfo
    void addGuildMemberInfo(GuildMemberInfo2* pGuildMemberInfo) {
