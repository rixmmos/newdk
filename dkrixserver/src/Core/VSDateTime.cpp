...
VSDateTime::VSDateTime(const VSDate& date) : d(date) {}

VSDateTime::VSDateTime(const VSDate& date, const VSTime& time) : d(date), t(time) {}

VSDateTime::VSDateTime(const VSDateTime& dt) : d(dt.d), t(dt.t) {}
