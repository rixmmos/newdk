...
public:
    ...
    static PacketSize_t getPacketMaxSize() throw() {
        return UpdateManager::getMaxSize() + szBYTE * 10;
    }
...
public:
    ...
    UpdateManager* getUpdateManager() throw() {
        return m_pUpdateManager;
    }
    void setUpdateManager(UpdateManager* pUpdateManager) throw() {
    ...
    void setFront(bool bFront = true) {
        m_Front = bFront;
    }
...
public:
    ...
    // get packet id
    PacketID_t getPacketID() const throw() {
        return Packet::PACKET_UC_UPDATE_LIST;
    }
