        ...
        if (pCreature->isSlayer()) {
            ...
            if (ItemObjectID == pPacket->getObjectID()) {
                ...
                case Slayer::WEAR_NECK:
                    if (IClass == Item::ITEM_CLASS_NECKLACE)
                        Success = true;
                    break;
                case Slayer::WEAR_FINGER1:
                    if (IClass == Item::ITEM_CLASS_RING || IClass == Item::ITEM_CLASS_COUPLE_RING)
                        Success = true;
                    break;
                ...
                case Slayer::WEAR_WRIST1:
                    if (IClass == Item::ITEM_CLASS_BRACELET)
                        Success = true;
                    break;
                ...
                case Slayer::WEAR_HAND3:
                    if (IClass == Item::ITEM_CLASS_GLOVE)
                        Success = true;
                    break;
                ...
                case Slayer::WEAR_LEG:
                    if (IClass == Item::ITEM_CLASS_TROUSER)
                        Success = true;
                    break;
                case Slayer::WEAR_FOOT:
                    if (IClass == Item::ITEM_CLASS_SHOES)
                        Success = true;
                    break;
                case Slayer::WEAR_RIGHTHAND:
                    if (isSlayerWeapon(IClass))
                        Success = true;
                    break;
                ...
                case Slayer::WEAR_ZAP4:
                    if (IClass == Item::ITEM_CLASS_CORE_ZAP)
                        Success = true;
                    break;
                case Slayer::WEAR_PDA:
                    if (IClass == Item::ITEM_CLASS_CARRYING_RECEIVER)
                        Success = true;
                    break;
                case Slayer::WEAR_SHOULDER:
                    if (IClass == Item::ITEM_CLASS_SHOULDER_ARMOR)
                        Success = true;
                    break;
                default:
                    break;
            ...
            if (ItemObjectID == pPacket->getObjectID()) {
                ...
                case Vampire::WEAR_FINGER1:
                    if (IClass == Item::ITEM_CLASS_VAMPIRE_RING || IClass == Item::ITEM_CLASS_VAMPIRE_COUPLE_RING)
                        Success = true;
                    break;
                ...
                case Vampire::WEAR_WRIST1:
                    if (IClass == Item::ITEM_CLASS_VAMPIRE_BRACELET)
                        Success = true;
                    break;
                ...
                case Vampire::WEAR_AMULET1:
                    if (IClass == Item::ITEM_CLASS_VAMPIRE_AMULET)
                        Success = true;
                    break;
                ...
                case Vampire::WEAR_DERMIS:
                    if (IClass == Item::ITEM_CLASS_DERMIS)
                        Success = true;
                    break;
                case Vampire::WEAR_PERSONA:
                    if (IClass == Item::ITEM_CLASS_PERSONA)
                        Success = true;
                    break;
            ...
            if (ItemObjectID == pPacket->getObjectID()) {
                ...
                case Ousters::WEAR_COAT:
                    if (IClass == Item::ITEM_CLASS_OUSTERS_COAT)
                        Success = true;
                    break;
                case Ousters::WEAR_LEFTHAND:
                case Ousters::WEAR_RIGHTHAND:
                    if (IClass == Item::ITEM_CLASS_OUSTERS_WRISTLET || IClass == Item::ITEM_CLASS_OUSTERS_CHAKRAM)
                        Success = true;
                    break;
                case Ousters::WEAR_BOOTS:
                    if (IClass == Item::ITEM_CLASS_OUSTERS_BOOTS)
                        Success = true;
                    break;
                ...
                case Ousters::WEAR_STONE4:
                    if (IClass == Item::ITEM_CLASS_OUSTERS_STONE)
                        Success = true;
                    break;
                ...
                case Ousters::WEAR_FASCIA:
                    if (IClass == Item::ITEM_CLASS_FASCIA)
                        Success = true;
                    break;
                case Ousters::WEAR_MITTEN:
                    if (IClass == Item::ITEM_CLASS_MITTEN)
                        Success = true;
                    break;
