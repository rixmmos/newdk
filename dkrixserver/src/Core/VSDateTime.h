...
public:
    bool operator==(const VSDate& d) const {
        return jd == d.jd;
    }
    bool operator!=(const VSDate& d) const {
        return jd != d.jd;
...
public:
    bool operator==(const VSTime& d) const {
        return ds == d.ds;
    }
    bool operator!=(const VSTime& d) const {
        return ds != d.ds;
...
public:
    ...
    const VSDate& date() const {
        return d;
    }
    const VSTime& time() const {
        return t;
    }

    void setDate(const VSDate& date) {
        d = date;
    }
    void setTime(const VSTime& time) {
        t = time;
    }
