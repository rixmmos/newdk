...
public:
    ...
    PacketID_t getPacketID() const {
        return PACKET_GC_MONSTER_KILL_QUEST_STATUS;
    }
    PacketSize_t getPacketSize() const {
        return szWORD + szWORD + szDWORD;
    }
    string getPacketName() const {
        return "GCMonsterKillQuestStatus";
    }
...
public:
    Packet* createPacket() {
        return new GCMonsterKillQuestStatus();
    }
    string getPacketName() const {
        return "GCMonsterKillQuestStatus";
    }
    PacketID_t getPacketID() const {
        return Packet::PACKET_GC_MONSTER_KILL_QUEST_STATUS;
    }
