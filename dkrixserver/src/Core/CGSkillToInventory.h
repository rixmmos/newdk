...
public:
    ...
    PacketSize_t getPacketSize() const {
        return szSkillType + szObjectID + szObjectID + szCoordInven * 4;
    }
...
public:
    ...
    CoordInven_t getTargetX() const {
        return m_TargetX;
    }
    void setTargetX(Coord_t TargetX) {
        m_TargetX = TargetX;
    }

    CoordInven_t getTargetY() const {
        return m_TargetY;
    }
    void setTargetY(Coord_t TargetY) {
        m_TargetY = TargetY;
    }
